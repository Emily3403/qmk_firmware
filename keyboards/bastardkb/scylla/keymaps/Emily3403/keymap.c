...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [1] = LAYOUT_split_4x6_5(
            ...
            KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,           KC_LCTL,   KC_HOME,   KC_PAGE_DOWN, KC_PAGE_UP, KC_END,    KC_NO,
    ...
    [2] = LAYOUT_split_4x6_5(
            QK_BOOT,             KC_PWR,   KC_SLEP,   KC_NO,   KC_NO,   KC_NO,           KC_NO,   KC_NO,   KC_NO,     KC_NO,     RGB_M_SN,   RGB_M_P,
    ...
    [4] = LAYOUT_split_4x6_5(
            ...
            KC_NO,   X(Dollar),   X(Euro),   X(Pound),   X(Yen),   KC_NO,                     XP(in, notin), XP(cap, cup), XP(subset, nsubset), XP(subseteq, nsubseteq), XP(exists, nexists), XP(eq, neq),
            ...
            KC_NO,   X(N),   X(Z),   X(Q),   X(R),   X(C),                          X(pm), X(cdot), X(times),  X(LRA), X(EnDash),   X(EmDash),
